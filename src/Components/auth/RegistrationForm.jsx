...
const RegistrationForm = () => {
  ...
  return (
    ...
    >
      {(formik) => (
        <Form className={`${fontClass} flex flex-col space-y-4 sm:space-y-6 bg-white p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-3xl`}>
