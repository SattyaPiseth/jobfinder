    ...
    return (
        ...
        {formik => (
            ...
            <h2 className="text-lg font-semibold text-blue-600">{t('registrationForm.title')}</h2>
            ...
            <button type="submit" disabled={isLoading || !formik.isValid} className="w-full bg-blue-600 text-white rounded-lg py-2 hover:bg-blue-700 disabled:opacity-50">
