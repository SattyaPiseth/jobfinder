...
const MenuList = ({ isLoading, menuList, fontClass, isOpen, setIsOpen }) => (
  <div className={`xl:flex justify-center space-x-10 ${isOpen ? "block" : "hidden"} xl:block transition-all duration-300 ease-in-out`}>
    {isLoading
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap items-center justify-between py-2 gap-4">
          ...
          <div className="hidden xl:flex flex-grow justify-center">
            <MenuList isLoading={isLoading} menuList={menuList} fontClass={fontClass} isOpen={isOpen} setIsOpen={setIsOpen} />
          </div>
