...
const FeatureDetailComponent = () => {
  return (
    <div>
      <section className="flex flex-col justify-center align-center py-16 max-w-full">
        <h2 className="self-center text-4xl leading-6 text-black">
          Feature on
        </h2>
        <article className="flex flex-col mt-12 text-base text-neutral-600 max-md:pl-5 max-md:mt-10 max-md:max-w-full">
          <p className="text-center max-md:max-w-full">
            ...
            (Teamwork, High Ambition, Strong Confident, Be the only ONE, Working
