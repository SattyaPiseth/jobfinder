...
const HeroSectionComponent = () => {
  return (
    ...
    >
      <div className="flex justify-center items-center px-4 py-10 bg-white md:px-16">
        <div className="w-full max-w-[1031px] mt-12 md:mt-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="flex flex-col">
              <div className="flex flex-col mt-4 md:mt-3.5">
                <h1 className="text-4xl md:text-7xl font-semibold text-blue-800 leading-tight md:leading-[79px] text-left">
                ...
                />
                <p className="mt-1.5 text-2xl leading-10 text-slate-600 text-left">
              ...
              <NavLink to="/login" className="self-start">
                <Button color={'#152f5c'}
                  className="px-8 py-1.5 mt-6 text-lg font-medium leading-8 text-white bg-blue-800 hover:bg-blue-700 active:bg-blue-900 shadow-sm rounded-full md:px-5"
                >
                  Try now
                </Button>
              </NavLink>
