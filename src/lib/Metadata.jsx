...
const Metadata = ({
  ...
  return (
    <Helmet>
      ...
      <meta property="og:image:alt" content={description || "Thumbnail image for Job Quick"} />
      ...
      <meta name="twitter:image:alt" content={description || "Thumbnail image for Job Quick"} />
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "name": "Job Quick",
          "url": fullUrl,
          "description": description || "Explore thousands of job opportunities across various industries on Job Quick.",
          "image": image,
          "author": {
            "@type": "Organization",
