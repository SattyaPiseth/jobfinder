  ...
  return (
    <Helmet>
      ...
      <meta name="description" content={
        description || "Explore thousands of job opportunities with Job Quick. Find jobs that match your skills and advance your career."
      } />
      <meta name="author" content={author || "Job Quick Team"} />
      <meta name="keywords" content={
        keywords || "jobs, careers, employment, job search, job opportunities, job portal, online jobs"
      } />
