...
export const login = (userCredentials) => apiClient.post('login/', userCredentials);
export const verifyOtpCode = ({ email, otp_code }) => apiClient.post('verify-otp/', { email, otp_code });
